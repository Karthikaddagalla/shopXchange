...
import 'update_existing_profile_details_model.dart';
export 'update_existing_profile_details_model.dart';

class UpdateExistingProfileDetailsWidget extends StatefulWidget {
  const UpdateExistingProfileDetailsWidget({
    super.key,
    this.phone,
  });
  ...
  @override
  _UpdateExistingProfileDetailsWidgetState createState() =>
      _UpdateExistingProfileDetailsWidgetState();
}

class _UpdateExistingProfileDetailsWidgetState
    extends State<UpdateExistingProfileDetailsWidget> {
  late UpdateExistingProfileDetailsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => UpdateExistingProfileDetailsModel());
  ...
  Widget build(BuildContext context) {
    ...
    return Title(
        title: 'updateExistingProfileDetails',
