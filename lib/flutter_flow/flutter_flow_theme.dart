...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF0E9F66);
  late Color secondary = const Color(0xFF1EAB71);
  late Color tertiary = const Color(0xFF0E9F66);
  late Color alternate = const Color(0xFF2CB47A);
  late Color primaryText = const Color(0xFF000000);
  late Color secondaryText = const Color(0xFF666666);
  late Color primaryBackground = const Color(0xFFF5F5F5);
  late Color secondaryBackground = const Color(0xFFFFFFFF);
  late Color accent1 = const Color(0xFFFFA726);
  late Color accent2 = const Color(0xFFFF7043);
  late Color accent3 = const Color(0xFFFF4081);
  late Color accent4 = const Color(0xFF7C4DFF);
...
class DarkModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF248E5A);
  late Color secondary = const Color(0xFF188C5A);
  late Color tertiary = const Color(0xFF0A7E4F);
  late Color alternate = const Color(0xFF1B8C5D);
  late Color primaryText = const Color(0xFFFFFFFF);
  late Color secondaryText = const Color(0xFFCCCCCC);
  late Color primaryBackground = const Color(0xFF282828);
