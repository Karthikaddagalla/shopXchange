...
import 'product_page_copy2_model.dart';
export 'product_page_copy2_model.dart';

class ProductPageCopy2Widget extends StatefulWidget {
  const ProductPageCopy2Widget({
    super.key,
  ...
  @override
  _ProductPageCopy2WidgetState createState() => _ProductPageCopy2WidgetState();
}

class _ProductPageCopy2WidgetState extends State<ProductPageCopy2Widget>
    with TickerProviderStateMixin {
  late ProductPageCopy2Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ProductPageCopy2Model());
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<UsersRecord>(
      stream: UsersRecord.getDocument(widget.shopDetails!.listedUser!),
      builder: (context, snapshot) {
        ...
        final productPageCopy2UsersRecord = snapshot.data!;
                              ...
                              child: Row(
                                ...
                                children: [
                                  ClipRRect(
                                    ...
                                    child: Image.network(
                                      productPageCopy2UsersRecord.photoUrl,
                                      width: 90.0,
                                      height: 90.0,
                                      fit: BoxFit.cover,
                                    ),
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        Row(
                                          ...
                                          children: [
                                            Text(
                                              'Since ${productPageCopy2UsersRecord.createdTime?.toString()}',
                                              style:
                                                  FlutterFlowTheme.of(context)
                                                      .labelMedium,
                                            ),
                          ...
                          onPressed: () async {
                            context.pushNamed(
                              ...
                              extra: <String, dynamic>{
                                'chatUser': productPageCopy2UsersRecord,
                              },
                            );
                          },
                          text: 'Chat',
